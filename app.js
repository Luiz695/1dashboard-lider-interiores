...
function exportToCSV(products) {
    const headers = [
        ...
        'IC Tabela Lider', 'IC Promocional Lider', 'Concorrente', 'Preço Tabela Concorrente',
        'Preço Promocional Concorrente', 'IC Tabela Concorrente', 'IC Promocional Concorrente', 'Diff Pesquisa',
        'Pesquisador', 'Record'
    ];
